...
void HardwareInterface::write()
{
  ...
  else if (strcmp(interface_.c_str(), "effort") == 0)
  {
    ...
    ROS_INFO_STREAM("Sending effort 0 " << dynamixel_effort[0]);
    ROS_INFO_STREAM("Sending effort 1 " << dynamixel_effort[1]);
    ROS_INFO_STREAM("Sending effort 2 " << dynamixel_effort[2]);
    ROS_INFO_STREAM("Sending effort 3 " << dynamixel_effort[3]);
    ROS_INFO_STREAM("Sending effort 4 " << dynamixel_effort[4]);
    ROS_INFO_STREAM("Sending effort 5 " << dynamixel_effort[5]);
